    ...
    return (
        <div className='group shadow-[0_0_5px_2px_rgba(0,0,0,0.2)]'>
            <NavLink to={`/Rooms/${roomType} `} className='inline-block overflow-hidden w-full relative'>
                ...
                <div className='absolute w-full h-full bg-black origin-bottom-right rotate-[-45deg] scale-[2.5] opacity-0 group-hover:opacity-60 group-hover:rotate-0 transition-all duration-[0.3s] rounded-full ease-linear group-hover:right-[-30%] group-hover:bottom-[-30%]'></div>
